...
class SceneTwo(Component):
    ...
    def __init__(self, shaderProg):
        ...
        l0 = Light(Point([-2.0, 1.5, 0.0]),
                   np.array((*ColorType.CYAN, 1.0)), None, Point((2.0, -1.5, 0.0)), np.array((0, 0, 0.3)), 3.0, 45)
        lightCube0 = Component(Point((-2.0, 1.5, 0.0)), DisplayableCube(shaderProg, 0.1, 0.1, 0.1, ColorType.CYAN))
        ...
        self.ambientMask = [np.array((0.1, 0.1, 0.1, 0.1)), np.array((0.1, 0.1, 0.1, 0.1)), np.array((0.1, 0.1, 0.1, 0.1))]
        self.diffuseMask = [np.array((0.2, 0.2, 0.2, 1)), np.array((0.8, 0.8, 0.8, 1)), np.array((0.2, 0.2, 0.2, 1))]
        self.specularMask = [np.array((0.4, 0.4, 0.4, 0.1)), np.array((0.8, 0.8, 0.8, 1.0)), np.array((0.6, 0.6, 0.6, 0.1))]
        self.lightMask = [l0, l1]
